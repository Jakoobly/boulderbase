...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {screen === 'home' && <Home profile={profile} groups={groups} setScreen={setScreen} onProfile={() => setScreen('profile')} onCreateGroup={createGroup} onJoinGroup={joinGroup} onOpenGroup={openGroup} onFree={() => startSetup('standalone')} onLogout={() => signOut(auth)} />}
